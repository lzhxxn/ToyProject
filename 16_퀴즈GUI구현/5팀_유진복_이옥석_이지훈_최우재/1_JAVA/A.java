...
class A extends JFrame implements ActionListener{
	...
	void loadImg(){
		try{
			...
			main0 = new ImageIcon(ImageIO.read(new File("Image/mainQ.png")));
			main1 = new ImageIcon(ImageIO.read(new File("Image/mainQQ.png")));
			main2 = new ImageIcon(ImageIO.read(new File("Image/mainQQQ.png")));
			main3 = new ImageIcon(ImageIO.read(new File("Image/mainQQQQ.png")));
			imageList [0] = main0;
			imageList [1] = main1;
			imageList [2] = main2;
			imageList [3] = main3;
